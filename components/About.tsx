const team = [
  {
    ...
    bio: "Eleanor founded Meridian Wealth Advisors in 2004 after a decade at a wirehouse where she grew frustrated with commission-based conflicts. She serves clients with complex portfolios across retirement planning, tax strategy, and estate coordination.",
    credentials: ["CFP®", "CFA"],
  },
  {
    initials: "MC",
    ...
    bio: "Marcus leads Meridian's investment committee and portfolio construction process. He draws on 15 years of institutional experience to design low-cost, evidence-based portfolios that reflect each client's unique risk tolerance and time horizon.",
    credentials: ["CFA"],
  },
  {
    initials: "PN",
    ...
    bio: "Priya specializes in the intersection of wealth management, estate law, and taxation. Her legal background allows Meridian to offer deeply integrated estate and tax planning that most advisory firms outsource entirely.",
    credentials: ["CFP®", "J.D."],
  },
];
